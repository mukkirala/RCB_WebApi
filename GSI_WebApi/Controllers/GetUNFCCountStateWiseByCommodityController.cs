...
{
    public class GetUNFCCountStateWiseByCommodityController : ApiController
    {
        public List<GetNoOfBlockAllAgency> Get(string CommodityID)
        {
            ...
            {
                string sqlString = "Get_UNFCCount_StateWise_ByCommodity";
